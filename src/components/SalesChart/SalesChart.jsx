    ...
    <ResponsiveContainer width="100%" height="100%">
        ...
        <ResponsiveContainer width="100%" height={500}>
          <BarChart
            ...
            barSize={20}
          >
            <XAxis dataKey="Date" scale="point" padding={{ left: 22, right: 10 }} />
            <YAxis />
            <Tooltip />
            <Legend />
            <CartesianGrid strokeDasharray="3 3" />
            <Bar dataKey="Giftcard" fill="#8884d8" background={{ fill: '#eee' }} />
            <Bar dataKey="Crypto" fill="#7704de" background={{ fill: '#eee' }} />
          </BarChart>
        </ResponsiveContainer>
      </div>
    );
